...
order_of_columns = c("Wealth Index 1967-75","COMPLETED YEARS OF SCHOOLING",
                     "Wealth Index 1987","Wealth Index 2002",
                     "RURAL RESIDENT","EMPLOYMENT = YES",
                     "Wealth Index 2015-18","Community Ladder in 2015-18",
...
model_path_bmi_gtml <- '
adbmi ~  pcall6775_1 + pcall1987_1 + pcall2002_1 + pcall1618_1 + employmentyn + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618 + rural
...
result_c_path_bmi <- sem(model_path_bmi_gtml,
                         data = model_df,
                         std.ov = FALSE,
                         cluster = "d_id_unim",
                         estimator = "mlr",
...
display_result_path(result_c_path_bmi) %>% 
...
model_path_srq_gtml <- '
adsrq ~  pcall6775_1 + pcall1987_1 + pcall2002_1 + pcall1618_1 + employmentyn + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618 + rural
...
result_c_path_srq <- sem(model_path_srq_gtml,
                         data = model_df,
                         std.ov = FALSE,
                         cluster = "d_id_unim",
                         estimator = "mlr",
...
display_result_path(result_c_path_srq) %>% 
  dplyr::select(iv,one_of(order_of_columns)) %>% 
  mutate(iv = factor(iv,levels=order_of_rows)) %>% 
  arrange(iv) %>% 
  knitr::kable(format="markdown") 
...
adhappy ~  pcall6775_1 + pcall1987_1 + pcall2002_1 + pcall1618_1 + employmentyn + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618 + rural
pcall1618_1 ~ gtadeduyr1618 + pcall6775_1 + pcall1987_1 + pcall2002_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + rural + employmentyn
employmentyn ~ pcall6775_1 + pcall1987_1 + pcall2002_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618 + rural
rural ~ pcall6775_1 + pcall1987_1 + pcall2002_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618
pcall2002_1 ~ gtadeduyr1618 + pcall6775_1 + pcall1987_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear
...
result_c_path_happy <- sem(model_path_happy_gtml,
                           data = model_df,
                           std.ov = FALSE,
                           cluster = "d_id_unim",
                           estimator = "mlr",
...
display_result_path(result_c_path_happy) %>% 
  dplyr::select(iv,one_of(order_of_columns)) %>% 
  mutate(iv = factor(iv,levels=order_of_rows)) %>% 
  arrange(iv) %>% 
  knitr::kable(format="markdown") 
...
model_path_community_gtml <- '
gtadladdercommunity2018 ~  pcall6775_1 + pcall1987_1 + pcall2002_1 + pcall1618_1 + employmentyn + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618 + rural
pcall1618_1 ~ gtadeduyr1618 + pcall6775_1 + pcall1987_1 + pcall2002_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + rural + employmentyn
employmentyn ~ pcall6775_1 + pcall1987_1 + pcall2002_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618 + rural
rural ~ pcall6775_1 + pcall1987_1 + pcall2002_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear + gtadeduyr1618
pcall2002_1 ~ gtadeduyr1618 + pcall6775_1 + pcall1987_1 + moscho_imputed + gtatole + exposure1000 + atole1000 + moage_imputed + sexM + byear
...
result_c_path_community <- sem(model_path_community_gtml,
                               data = model_df,
                               std.ov = FALSE,
                               cluster = "d_id_unim",
                               estimator = "mlr",
...
display_result_path(result_c_path_community) %>% 
  dplyr::select(iv,one_of(order_of_columns)) %>% 
  mutate(iv = factor(iv,levels=order_of_rows)) %>% 
  arrange(iv) %>% 
  knitr::kable(format="markdown") 
...
result_c_path_economic <- sem(model_path_economic_gtml,
                              data = model_df,
                              std.ov = FALSE,
                              cluster = "d_id_unim",
                              estimator = "mlr",
...
display_result_path(result_c_path_economic) %>% 
  dplyr::select(iv,one_of(order_of_columns)) %>% 
  mutate(iv = factor(iv,levels=order_of_rows)) %>% 
  arrange(iv) %>% 
  knitr::kable(format="markdown")
...
tab3_cols = c("Wealth Index 1967-75",
              "COMPLETED YEARS OF SCHOOLING",
              "Wealth Index 1987",
              "Wealth Index 1996",
              "Wealth Index 2002",
...
consolidated <- bind_rows(
  ...
  display_result_path(result_c_path_bmi,wider=FALSE),
  ...
  dplyr::select(dv,one_of(tab3_cols))
